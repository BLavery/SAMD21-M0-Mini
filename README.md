...
Using the new bootloader, it is to cross over to circuitpython from arduino use. As easy as just copying the circuitpython UF2 image file. (This is the __firmware.uf2__ from above, not the .bin format this time.)
